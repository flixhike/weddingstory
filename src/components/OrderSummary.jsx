...
const OrderSummary = ({ 
  ...
  if (!selectedPackage) {
    return (
      <Card className="glass-effect-dark border-white/10 sticky top-20 elegant-shadow">
        ...
        <CardContent className="space-y-6">
          ...
          >
            <div className="bg-gradient-to-br from-red-500/5 to-red-500/10 rounded-xl p-4 border border-red-500/20">
              ...
              <div className="grid grid-cols-2 gap-2 mt-3 pt-3 border-t border-red-500/20">
                ...
                {selectedPackage.features.length > 4 && (
                  <div className="col-span-2 text-xs text-red-500 font-medium">
              ...
              <div className="space-y-2">
                {selectedAddons.map((addon, index) => (
                  <motion.div 
                    ...
                    className="bg-white/5 rounded-lg p-3 border border-foreground/10"
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-bold text-red-500 ml-3">
          ...
          {isQuote && (
            ...
            >
              <p className="text-sm text-foreground/80 leading-relaxed">
                <strong className="text-red-500">Custom Quote:</strong> We'll provide a personalized quote based on your specific requirements and location.
              </p>
            </motion.div>
          )}
        </CardContent>
